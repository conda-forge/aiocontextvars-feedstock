About aiocontextvars-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiocontextvars-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6207&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiocontextvars-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiocontextvars` can be installed with `conda`:
...
```
mamba install aiocontextvars
```

It is possible to list all of the versions of `aiocontextvars` available on your platform with `conda`:
...
```
mamba search aiocontextvars --channel conda-forge
```
...
mamba repoquery search aiocontextvars --channel conda-forge

# List packages depending on `aiocontextvars`:
mamba repoquery whoneeds aiocontextvars --channel conda-forge

# List dependencies of `aiocontextvars`:
mamba repoquery depends aiocontextvars --channel conda-forge
```
